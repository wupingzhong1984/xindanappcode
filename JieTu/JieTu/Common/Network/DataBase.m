...
//  Campus Life
//
//  Created by cf-finance on 14-7-10.
...
- (void)open
{
    ...
    if (ret != SQLITE_OK)
    {
        ...
        UIAlertView *alertView= [[UIAlertView alloc] initWithTitle:@"错误" message:@"数据文件损坏，请删除数据文件" delegate:self cancelButtonTitle:@"确定" otherButtonTitles: nil];
    ...
    if (sqlite3_exec(database, cacheTable, NULL, NULL, &errorMsg) != SQLITE_OK)
    {
        ...
        UIAlertView *alertView= [[UIAlertView alloc] initWithTitle:@"错误" message:[NSString stringWithUTF8String:errorMsg] delegate:self cancelButtonTitle:@"确定" otherButtonTitles: nil];
